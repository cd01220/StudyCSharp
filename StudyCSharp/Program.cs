...
namespace StudyCSharp
{
    public class Program
    {
        private static void Main(string[] args)
        {
            ...
            int count0 = 10;
            double[] hi0 = { 8766.00, 8880.00, 8481.00, 8535.00, 8530.00, 8511.84, 8405.25, 8188.00, 8207.30, 8200.00 };
            double[] lo0 = { 8490.00, 8325.00, 8260.00, 8329.00, 8177.00, 8283.79, 7995.00, 7962.00, 7854.00, 7919.65 };

            Sar sar = new Sar(0.02d, 0.2d, 4);
            sar.SetCycle0(hi0[0], lo0[0], 7751.00d, 0.02d);
            for (int i = 1; i < count0; ++i)
            {
                double value = sar.AddCycle(hi0[i], lo0[0]);
